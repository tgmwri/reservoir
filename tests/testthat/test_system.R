...
test_that("deficits for system of four hourly empty reservoirs are calculated", {
    ...
    resul = calc_deficits(sys, yields, initial_storages)

    expect_equal(resul$single$A1$storage, 86400 * c(1, 4, 9, 9, 8, 7))
    expect_equal(resul$single$A1$yield, rep(4, 6))
    expect_equal(resul$single$A1$deficit, rep(0, 6))
    expect_equal(resul$single$A2$storage, 86400 * c(0, 4, 9, 8, 6, 3))
    expect_equal(resul$single$A2$yield, rep(7, 6))
    expect_equal(resul$single$A2$deficit, rep(0, 6))
    expect_equal(resul$single$B$storage, 86400 * c(0, 4, 9, 4, 0, 3))
    expect_equal(resul$single$B$yield, c(18, 20, 20, 20, 18, 20))
    expect_equal(resul$single$B$deficit, 86400 * c(2, 0, 0, 0, 2, 0))
    expect_equal(resul$single$C$storage, 86400 * c(0, 4, 8, 1, 0, 3))
    expect_equal(resul$single$C$yield, c(25, 29, 29, 29, 24, 29))
    expect_equal(resul$single$C$deficit, 86400 * c(4, 0, 0, 0, 5, 0))

    expect_equal(resul$system$A1$storage, 86400 * c(0, 3, 8, 8, 3.23077, 2.23077), tolerance = 1e-5)
    expect_equal(resul$system$A1$yield, rep(4, 6))
    expect_equal(resul$system$A1$deficit, rep(0, 6))
    expect_equal(resul$system$A1$transfer, 86400 * c(-1, 0, 0, 0, -3.76923, 0), tolerance = 1e-5)
    expect_equal(resul$system$A2$storage, 86400 * c(0, 4, 9, 8, 2.76923, 0), tolerance = 1e-5)
    expect_equal(resul$system$A2$yield, c(rep(7, 5), 6.76923), tolerance = 1e-5)
    expect_equal(resul$system$A2$deficit, 86400 * c(rep(0, 5), 0.23077), tolerance = 1e-5)
    expect_equal(resul$system$A2$transfer, 86400 * c(0, 0, 0, 0, -3.23077, 0), tolerance = 1e-5)
    expect_equal(resul$system$B$storage, 86400 * c(0, 4, 9, 4, 0, 3))
    expect_equal(resul$system$B$yield, c(19, rep(20, 5)))
    expect_equal(resul$system$B$deficit, 86400 * c(1, rep(0, 5)))
    expect_equal(resul$system$B$transfer, 86400 * c(1, 0, 0, 0, 2, 0))
    expect_equal(resul$system$C$storage, 86400 * c(0, 4, 8, 1, 0, 3))
    expect_equal(resul$system$C$yield, c(25, rep(29, 5)))
    expect_equal(resul$system$C$deficit, 86400 * c(4, rep(0, 5)))
    expect_equal(resul$system$C$transfer, 86400 * c(rep(0, 4), 5, 0))
})
